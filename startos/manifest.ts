...
export const manifest = setupManifest({
  ...
  title: "BTCPay Server",
  version: "1.9.3",
  releaseNotes: "Updated to use new APIs in StartOS 0.4.0",
  license: "mit",
  replaces: [],
